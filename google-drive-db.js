...
class GoogleDriveDB {
  ...
  /**
   * Carrega todas as ações registradas na planilha do Sheets (colunas A a M).
   */
  ...
  /**
   * Sobrescreve toda a lista de ações na planilha para sincronização total simplificada (colunas A a M).
